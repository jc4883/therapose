...
class VideoCall extends React.Component{
  ...
  componentDidMount(){
    document.getElementById("root").classList.add("full-width");
    ...
    render(){
        ...
        return(<div className="VideoCall">
                    ...
                    <div className="buttons">
                        <input className="join-button" type="image" src={window.pick_up} onClick={this.joinCall.bind(this)}/>
                        <input className="leave-button" type="image" src={window.hang_up} onClick={this.leaveCall.bind(this)}/>
                    </div>
